...
public class Player {
    ...
    public SportEvents4Club.Level getLevel(){
        int intLevel = getNumRatings();
        return LevelHelper.getLevel(intLevel);
    }
    ...
    public void addRating(SportEvents4Club.Rating rating, String message){
        Rating r = new Rating(rating,message, this);
        ratings.insertEnd(r);
    }
}
